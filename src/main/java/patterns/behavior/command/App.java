...
import patterns.behavior.command.impl.CopyCommand;
import patterns.behavior.command.impl.CutCommand;
import patterns.behavior.command.impl.PasteCommand;
import patterns.behavior.command.impl.UndoCommand;
